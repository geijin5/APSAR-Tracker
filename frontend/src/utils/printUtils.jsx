  ...
  return (
    <PrintLayout
      ...
      headerInfo={{
        ...
        'Scheduled Date': record.scheduledDate ? new Date(record.scheduledDate).toLocaleDateString() : 'N/A',
        'Due Date': record.dueDate ? new Date(record.dueDate).toLocaleDateString() : 'N/A',
        'Completed Date': record.completedDate ? new Date(record.completedDate).toLocaleDateString() : 'N/A',
  ...
  return (
    <PrintLayout
      ...
      headerInfo={{
        ...
        'Scheduled Start': workOrder.scheduledStartDate ? new Date(workOrder.scheduledStartDate).toLocaleDateString() : 'N/A',
        'Scheduled End': workOrder.scheduledEndDate ? new Date(workOrder.scheduledEndDate).toLocaleDateString() : 'N/A'
      }}
      footer="This document was generated by APSAR Tracker"
    >
      <div>
              ...
              <tbody>
                {reportData.maintenance.map((record, index) => (
                  <tr key={index}>
                    ...
                    <td>{record.completedDate ? new Date(record.completedDate).toLocaleDateString() : 'N/A'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
